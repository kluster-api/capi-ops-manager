...
uninstall:
	@cd ../installer; \
	helm uninstall capi-ops-manager --namespace=$(KUBE_NAMESPACE) || true
...
.PHONY: run
run:
	go run -mod=vendor ./cmd/capi-ops-manager run \
		--v=3 \
		--secure-port=8443 \
